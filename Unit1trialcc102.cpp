...
class Question
{
  public:
    ...
    Question() {}
    Question(String text, String ans1, String ans2, String ans3, String ans4,
        int correctAns)
    {
        Text = text;
        Answer1 = ans1;
...
std::queue<Question> LoadQuestions()
{
    ...
    Question q2 = Question(
        "2. The mango tree branch has 13 leaves on one side and 29 on the other side. How many leaves are on the branch?",
        "42", "32", "36", "50", 1);
    Question q3 = Question(
        "3. John sold twice as many apples in the afternoon than in the morning. If he sold 360 kilograms of apples that day, how many kilograms did he sell in the morning and how many in the afternoon?",
        "130", "131", "132", "134", 1);
    Question q4 = Question(
        "4. Daisy has twice as many friends as Lilly. Rose has 5 friends, which is 9 fewer than Daisy has. How many friends does Lilly have?",
        "14", "21", "7", "8", 3);
    Question q5 = Question("5. Who created the painting Mona Lisa?",
        "Jerome Cabral", "Trixie Malinao", "Ryan Bernales",
        "Airhon Villiafuerte", "Leonardo da Vinci", 4);
